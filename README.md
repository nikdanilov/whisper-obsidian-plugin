...
Record or upload audio, transcribe with [OpenAI Whisper](https://openai.com/research/whisper), and optionally polish the result with an LLM. Works on desktop and mobile.
